...
export default function ClientRegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    // Pegando ref code pela URL via JS puro para evitar hook hydration bugs em Client Components sem Suspense fallback
    ...
    try {
      const res = await fetch("/api/cliente/cadastro", {
        ...
        body: JSON.stringify({ name, email, phone, password, ref: refCode }),
      });
